...
class ChallengeEventPublisherTest {
    private ChallengeEventPublisher challengeEventPub;
    @Mock
    private AmqpTemplate amqpTemplate;

    @BeforeEach
    public void setUp() {
        challengeEventPub = new ChallengeEventPublisher(amqpTemplate,
                "test.topic");
    }
    ...
    public void sendsAttempt(boolean correct) {
        ...
        // when
        challengeEventPub.publishChallengeSolvedEvent(attempt);
        // then
